...
_ZERO_SEARCHES: dict[str, list[str]] = {
    "electronics": [
        "wireless charging stand 3-in-1 kenya",
        "magsafe compatible phone stand",
        "mechanical numpad bluetooth tkl",
        "usb-c to hdmi 4k cable nairobi",
        "solar power bank for camping kenya",
        "type-c hub docking station",
    ],
    "fashion": [
        "wide-fit running shoes women kenya",
        "sustainable linen trousers men",
        "waterproof ankle boots nairobi",
        "oversized linen summer dress kenya",
        "ankara print sneakers",
        "unisex bucket hat kenya",
    ],
    "furniture": [
        "standing desk cable management tray",
        "ergonomic kneeling chair nairobi",
        "foldable wall bed with desk kenya",
        "bamboo floating corner shelf",
        "monitor arm dual screen mount",
        "acoustic foam panels office",
    ],
    "beauty": [
        "retinol serum 0.5 percent sensitive skin",
        "mineral tinted sunscreen spf50 dark skin",
        "niacinamide serum 10 percent kenya",
        "vegan collagen overnight face cream",
        "kojic acid soap kenya",
        "natural hair growth oil black hair",
    ],
    "food": [
        "plant-based protein powder 2kg kenya",
        "cold brew coffee concentrate nairobi",
        "grass-fed ghee 500g",
        "ceremonial grade matcha kenya",
        "moringa leaf powder organic nairobi",
        "sourdough starter kit kenya",
    ],
    "other": [
        "premium gift bundle set kenya",
        "custom branded packaging nairobi",
        "bulk order wholesale kenya",
        "personalised gift box nairobi",
    ],
}
